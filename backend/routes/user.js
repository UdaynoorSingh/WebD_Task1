...
const updateProgress = async (userId, questionId, action, listType)=>{
...
router.post('/progress', protect, async (req, res)=>{
  try{
    ...
    const progress = await updateProgress(req.user._id, questionId, action, 'progress');
    res.json({
...
router.post('/bookmarks', protect, async (req, res) =>{
  try{
    const {questionId, action} = req.body;
    const progress = await updateProgress(req.user._id, questionId, action, 'bookmarks');
    res.json({
